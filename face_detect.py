...
def classify_face (img) -> dict:
	...
	It returns the top 5 classes that the face belongs to along with their accuracies.
	[TODO]: The classifier has not been implemented yet.
	'''
	class_acc = {
		'dummy1': 0.09,
		'dummy2': 0.06,
